...
AuthenticatorAsyncTask.OnAuthenticatorTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHostUrlInput.setText(sData.getJoinUrl());
    ...
    public void onOkClick(View view) {
        ...
        if (mServerInfo.mVersion == null || 
            ...
            new AccountNetworkHandler(this).execute("4", mUsernameInput.getText().toString());
     ...
     */
    public void onRegisterClick(View view) { // new account button listener
        ...
        final AccountRegisterDialog mAlertBuilder;

        mAlertBuilder = new AccountRegisterDialog(this, this);
        
        mAlertBuilder.setPositiveButton(R.string.common_ok, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(mAlertBuilder.checkInfo()){
                    mAlertBuilder.sendInfo();
                }
               
            }
        });
        mAlertBuilder.setNeutralButton(R.string.common_cancel, new OnClickListener() {
